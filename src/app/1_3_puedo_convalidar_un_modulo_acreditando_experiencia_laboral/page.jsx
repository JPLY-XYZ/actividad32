    ...
    <>
      ...
      <div className="w-[80%]">
        ...
        <p className="text-[16px] leading-5 pb-4">
          ...
          <b>certificado de profesionalidad</b> o bien porque ha participado en
          un
          <a
        ...
        <p className=" text-[18px] leading-5">
          ...
          <b>
            ...
            aportadas para solicitar la convalidación de módulos profesionales
            según lo regulado en el anexo V.A del Real Decreto
          </b>
          que regula cada título siempre que se aporte el
          <b>certificado de profesionalidad</b> o la
          <b>
            certificación oficial de la acreditación de la Unidad de
            Competencia.
          </b>
        </p>
        </div>
