    ...
    <>
      ...
      <div className="flex flex-col gap-4">
        <p>
          ...
          correspondiente, en el centro. En ningún caso puedes enviar por tu
          cuenta la solicitud al Ministerio.
        </p>
        ...
        <ItemLista>
          ...
          >
            enlace (ver &quot;Impreso solicitud convalidación módulos
            profesionales&quot;)
          </a>
          ...
          <b>
            ...
            cada centro, el apartado &quot;Módulos ofertados de este
            ciclo&quot;. Recuerda que el plazo para enviar la solicitud de
            convalidación concluye a finales de octubre
          </b>
          .
        </ItemLista>

        <ItemLista>
          <b>Fotocopia del Documento Nacional de Identidad</b> (DNI) o fotocopia
          del Pasaporte o de la Tarjeta de Extranjero/a o del Permiso de
          Residencia (temporal o definitivo) o del Visado de Estudios.
        </ItemLista>

        <ItemLista>
          Además, debe incluirse la siguiente documentación,
          <b>ya sea original o fotocopia compulsada</b> (recuerda que puedes
          compulsar un documento en cualquier Administración Pública que cuente
          con registro simplemente presentando la copia y enseñando el
          original):
        </ItemLista>
        ...
        <ItemLista interior={true}>
          ...
          . En el caso de que desees convalidar alegando haber cursado otro
          ciclo formativo, es suficiente con el certificado académico de notas y
          no es necesario que adjuntes también la copia del título o el
        ...
        <ItemLista interior={true}>
          ...
          <b>duración y contenidos teóricos y prácticos estudiados</b>.
        </ItemLista>
        ...
        <p>
          <b>
            Aunque ya se ha dicho anteriormente, se recuerda que
            <span className="underline">
              todos los documentos (excepto el DNI y el documento de la
              solicitud de convalidación) tienen que ser original o copia
              compulsada
            </span>
            .
            <span className="underline">
              También se recuerda que el centro no puede tramitar ante el
              Ministerio de Educación ninguna solicitud que no venga acompañada
        ...
        <p>
          <b>
            <span className="underline">
              El solicitante deberá estar matriculado en los módulos
              profesionales que solicita convalidar y haber satisfecho los
              derechos de matrícula en las enseñanzas para las cuales solicita
              la convalidación.
            </span>
          </b>
        </p>
        ...
        <p>
          ...
          <b>no podrá superar el 60% de la totalidad de créditos ECTS</b>
        ...
        <Image
          className="w-[300px] h-[332px] self-center"
